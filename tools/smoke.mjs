...
const TRACK_NAMES = { rustfall: 'Elkarim', cryostatic: 'Frosthelm', aetherion: 'Namaresh', hollowchoir: 'Centurion Prime', emberfall: 'Ashkar', abyssal: 'Meridian Deep', halcyon: 'Halcyon Bay', neonspire: 'Zhen-9' }
